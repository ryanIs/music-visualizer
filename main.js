...
var HEIGHT
var REMOVE_UI = false
var isRyanCode = getQueryVariable("a");
...
window.onload = function() {
	...
	function renderFrame() {
		...
		if(isRyanCode == false) {
			funcBigBars()
		} else if(isRyanCode == "2") {
			funcBigBars()
			funcCircles(dataArray, bufferLength, ctx);
		}  else if(isRyanCode == "3") {
			funcCircles(dataArray, bufferLength, ctx);
			funcBigBars()
		} else {
			funcCircles(dataArray, bufferLength, ctx);
	...
	// audio.src = "C:\\Users\\DIsler\\_Root\\Projects\\Watch It Burn Down\\music\\iterations\\25\\album_song_25.wav";
};
